...
router.post('/list', postMiddleWare, ctrl.post_card_list );
router.post('/view', postMiddleWare, ctrl.post_card_view );
router.post('/exist_img', postMiddleWare, ctrl.post_img_exist );

router.post("/actResult", postMiddleWare, ctrl.post_card_result);

router.post("/login", ctrl.post_card_login);
router.post("/logout", postMiddleWare, ctrl.post_card_logout);
